...
urlpatterns = [
    ...
    re_path(r"^engagement/(P<eid>\d+)/risk_assessment/add$",
            views.add_risk_assessment, name="add_risk_assessment"),
    re_path(r"^engagement/(?P<eid>\d+)/risk_assessment/add/(?P<fid>\d+)$",
        views.add_risk_assessment, name="add_risk_assessment"),
    re_path(r"^engagement/(?P<eid>\d+)/risk_assessment/(?P<fid>\d+)$",
        views.view_risk_assessment, name="view_risk_assessment"),
    re_path(r"^engagement/(?P<eid>\d+)/risk_assessment/(?P<fid>\d+)/edit$",
        views.edit_risk_assessment, name="edit_risk_assessment"),
    re_path(r"^engagement/(?P<eid>\d+)/risk_assessment/(?P<fid>\d+)/delete$",
        views.delete_risk_assessment, name="delete_risk_assessment"),
